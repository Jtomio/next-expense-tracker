...
export const TemplateContainer = tw.div`
  w-screen h-screen bg-gray-50 flex flex-col items-center justify-center mx-auto px-10
`
export const TemplateContent = tw.div`
  w-full max-w-screen-lg my-10 h-full px-8 rounded-md grid md:grid-cols-2 grid-cols-1 bg-white
`
